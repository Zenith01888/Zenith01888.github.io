(function () {
  ...
  const I18N = {
    zh: {
      ...
      "project.studyroom.aria": "打开云上自习室",
      "project.studyroom.cover": "云上自习室项目封面",
      "project.studyroom.title": "云上自习室",
      "project.studyroom.date": "更新于 2026-08-15",
      "project.studyroom.meta": "工具 · 专注",
      "project.studyroom.desc": "沉浸式在线自习室，支持番茄钟、待办、学习统计、一言 Tips、音乐电台与歌词、网易云音乐氛围音与全屏模式，数据保存在本地浏览器。",
      ...
      "project.oscilloscope.desc": "基于 Python、Flask 和 PyVISA 的示波器 Web 上位机，支持 YOKOGAWA DLM2024 / RIGOL / Keysight；GitHub Pages 提供浏览器演示，真实硬件需本地运行 Flask。",
      ...
      "aside.recent.studyroom": "云上自习室",
      "aside.recent.studyroom.date": "2026-08-15",
    ...
    en: {
      ...
      "nav.tools": "Tools",
      "nav.tools.pdfmerge": "Pdfmerge",
      "nav.tools.studyroom": "Study Room",
      ...
      "project.studyroom.aria": "Open study room",
      "project.studyroom.cover": "Study room project cover",
      "project.studyroom.title": "Study Room",
      "project.studyroom.date": "Updated 2026-08-15",
      "project.studyroom.meta": "Tools · Focus",
      "project.studyroom.desc": "An immersive online study room with Pomodoro, tasks, focus stats, tips, a music player with lyrics, NetEase Cloud Music ambient audio, and fullscreen mode. Data stays in your browser.",
      ...
      "project.oscilloscope.desc": "An oscilloscope web console built with Python, Flask, and PyVISA, supporting YOKOGAWA DLM2024 / RIGOL / Keysight; GitHub Pages hosts a browser demo while real hardware requires the local Flask app.",
      ...
      "aside.recent.studyroom": "Study Room",
      "aside.recent.studyroom.date": "2026-08-15",
      "aside.recent.pdfmerge": "Pdfmerge",
      "aside.recent.pdfmerge.date": "2026-08-14",
      "aside.recent.pwm": "PWM Monitor",
