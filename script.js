(function () {
  ...
  const I18N = {
    zh: {
      ...
      "project.studyroom.desc": "沉浸式在线自习室，支持番茄钟、待办、学习统计、氛围音与全屏模式，数据保存在本地浏览器。",
    ...
    en: {
      ...
      "project.studyroom.desc": "An immersive online study room with Pomodoro, tasks, focus stats, ambient sound, and fullscreen mode. Data stays in your browser.",
